...
package com.dingapp.biz.page.timepackers;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		...
		// setBackgroundResource(R.drawable.time_picker_wheel_bg);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		centerDrawable.setBounds(-2, center - offset, getWidth() + 2, center
				+ offset);
