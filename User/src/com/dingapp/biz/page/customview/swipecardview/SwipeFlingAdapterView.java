package com.dingapp.biz.page.customview.swipecardview;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    //缩�?��???????????
    private int yOffsetStep; // view???????????��??移�?????步�??
    private static final float SCALE_STEP = 0.08f; // view??????缩�?��??步�??
    //缩�?��???????????

    private int MAX_VISIBLE = 4; // ??�建�????�?�?4
    ...
    @SuppressLint("NewApi") private void adjustChildView(View child, int index) {
   ...
   @SuppressLint("NewApi") private void adjustChildrenOfUnderTopView(float scrollRate) {
