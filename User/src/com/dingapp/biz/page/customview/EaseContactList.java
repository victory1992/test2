...
import com.dingapp.biz.page.adapters.EaseContactAdapter;
...
public class EaseContactList extends RelativeLayout {
    ...
    protected List<MobileMemberBean> contactList;
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_UPDATE_LIST:
                if(adapter != null){
                	adapter.clear();
                	adapter.addAll(new ArrayList<MobileMemberBean>(contactList));
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.hulu_ease_widget_contact_list, this);
     ...
     * init view
     */
    public void init(List<MobileMemberBean> contactList){
    	this.contactList = contactList;
        adapter = new EaseContactAdapter(context, 0, new ArrayList<MobileMemberBean>(contactList));
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				adapter.getItem(arg2).setChecked(!adapter.getItem(arg2).isChecked());
				adapter.notifyDataSetChanged();
				if(l!=null){
					l.shortClick(adapter.getMobileList());
				}
			}
    ...
    public List<MobileMemberBean> getContact(){
    	return adapter.getMobileList();
    }
    public void setChecked(boolean b){
    	if(adapter.getMobileList()!=null){
    		for (int i = 0; i < adapter.getMobileList().size(); i++) {
    			adapter.getMobileList().get(i).setChecked(b);
			}
    	}
    	adapter.notifyDataSetChanged();
    }
    ...
    public interface ItemClickListener{
    	void shortClick(List<MobileMemberBean> mobileList);
    	void longClick();
    }
