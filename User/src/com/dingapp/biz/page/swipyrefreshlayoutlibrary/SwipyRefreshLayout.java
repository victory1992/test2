...
package com.dingapp.biz.page.swipyrefreshlayoutlibrary;
...
public class SwipyRefreshLayout extends ViewGroup {
	...
	public SwipyRefreshLayout(Context context, AttributeSet attrs) {
		...
		SwipyRefreshLayoutDirection direction = SwipyRefreshLayoutDirection
				.getFromInt(a2.getInt(
						R.styleable.SwipyRefreshLayout_srl_direction, 0));
		...
		try {
			...
			case BOTTOM:
				if (!isEnabled() || mReturningToStart || canChildScrollDown()
						|| mRefreshing) {
					// Fail fast if we're not in a state where a swipe is
					// possible
					return false;
				}
				break;
			...
			Log.e(TAG,
					"An exception occured during SwipyRefreshLayout onTouchEvent "
							+ e.toString());
		}
