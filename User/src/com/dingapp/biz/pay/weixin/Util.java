...
public class Util {
	...
	public static byte[] httpGet(final String url) {
		...
		try {
			...
			if (resp.getStatusLine().getStatusCode() != HttpStatus.SC_OK) {
				LogUtils.e(TAG, "httpGet fail, status code = "
			...
			LogUtils.e(TAG, "httpGet exception, e = " + e.getMessage());
			e.printStackTrace();
			return null;
		}
	}
	...
	public static byte[] readFromFile(String fileName, int offset, int len) {
		...
		LogUtils.d(TAG, "readFromFile : offset = " + offset + " len = " + len
	...
	public static Bitmap extractThumbNail(final String path, final int height,
		...
		try {
			...
			LogUtils.d(TAG, "extractThumbNail: extract beX = " + beX
					+ ", beY = " + beY);
			...
			LogUtils.i(TAG, "bitmap required size=" + newWidth + "x"
