...
public class EaseChatFragment extends BaseFragment {
	...
	protected void setUpView() {
		...
		if (chatType == EaseConstant.CHATTYPE_SINGLE) { // 单聊
			// 设置标题
			if (EaseUserUtils.getUserInfo(toChatUsername, getActivity()) != null) {
				titleBar.setTitle(EaseUserUtils.getUserInfo(toChatUsername,
						getActivity()).getNickName());
			} else {
				titleBar.setTitle(toChatUsername);
			}
			titleBar.setRightImageResource(R.drawable.chat_personal);
		} else {
		...
		titleBar.setRightLayoutClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// .query(toChatUsername);
				// if (easeUser != null && "true".equals(easeUser.getIs_corp()))
				// {
				// UIUtil.showToast(getActivity(), "葫芦红包官方小助手");
				// return;
				// }
				...
				// bundle.putString(
				// "member_id",
				// toChatUsername.substring(11,
				// toChatUsername.length()));
				// }
		...
		messageList
				.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
					...
					public void onUserAvatarClick(String username) {
						...
						if ("true".equals(easeUser.getIs_corp())
								&& easeUser.getUsername().equals(
										"huluhongbao"
												+ AppConstants.member
														.getMemberId())) {
							...
							return;
							// 本人
						} else if ("true".equals(easeUser.getIs_corp())
								&& !easeUser.getUsername().equals(
										"huluhongbao"
												+ AppConstants.member
														.getMemberId())) {
							...
							String subSequence = easeUser.getUsername()
									.substring(11,
											easeUser.getUsername().length());
							OpenPageToMemberDetailUtils.openPage(
									EaseChatFragment.this, subSequence, false);
						}
					}
	...
	private void showCancledDilog(final Intent data) {
		cancled_dialog = new Dialog(getActivity(),
				com.dingapp.andriod.z20.R.style.dialog_style);
		View inflate = View.inflate(getActivity(),
				com.dingapp.andriod.z20.R.layout.cancled_layout, null);
		((TextView) (inflate
				.findViewById(com.dingapp.andriod.z20.R.id.tv_content)))
				.setText("你确定要发送图片吗？");
		inflate.findViewById(com.dingapp.andriod.z20.R.id.tv_cancled)
		...
		inflate.findViewById(com.dingapp.andriod.z20.R.id.tv_confirm)
				.setOnClickListener(new OnClickListener() {
	...
	public void setOnClickLeftListener(OnClickLeftListener l) {
		this.l = l;
	}
	...
	protected void onDataReset(Bundle bundle) {
		...
		if (bundle != null && bundle.containsKey("need_update")) {
			boolean1 = bundle.getBoolean("need_update");
			if (boolean1) {
