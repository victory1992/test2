...
import view.refresh.internal.FlipLoadingLayout;
import view.refresh.internal.LoadingLayout;
import view.refresh.internal.ViewCompat;
...
//					return new TweenAnimLoadingLayout(context, mode, scrollDirection, attrs); 
					new FlipLoadingLayout(context, mode, scrollDirection, attrs);
				case FLIP:
